...
public class MainWindowView  extends JFrame{
	...
	private void configureCenterPanel(){
		...
		jtaText = new JTextArea ("Escriu aqui el text a enviar.");
	...
	public String getText(){
		System.out.println(jtaText.getText().length());
		return jtaText.getText();
	}
	
	public Object getBaudRate(){
		return comboBaud.getSelectedItem();
	}
	
	public Object getSelectedPort(){
		return comboPort.getSelectedItem();
	}
